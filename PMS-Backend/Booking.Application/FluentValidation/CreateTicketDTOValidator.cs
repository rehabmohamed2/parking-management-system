...
public class CreateTicketDTOValidator: AbstractValidator<CreateTicketDTO>
{
    public CreateTicketDTOValidator()
    {
        ...
        RuleFor(x => x.SiteId)
            ...
            .NotEqual(Guid.Empty).WithMessage("Invalid Site ID");

        
        RuleFor(x => x.NoOfHours)
            .NotEmpty().WithMessage("Number of hours is required")
            .InclusiveBetween(1, 24).WithMessage("Number of hours must be between 1 and 24");
